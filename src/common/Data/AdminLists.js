export const SideBarLists = [
  ...
  },
  {
    ...
    subtitle2Link: "/admin/toyprj",
    subtitle3Link: "/admin/toyprj",
    subtitle4Link: "/admin/toyprj",
    subtitle5Link: "/admin/toyprj",
  },
  {
    icon: "icon",
    title: "contact",
...
export const WebProjectList = [
  ...
  },
  {
    title: "O**(ADMIN)",
    description:
      "특정질병 환자들을 위한 1:1 모니터링 및 다이어리 앱용 어드민(레이아웃 작업)",
...
export const AppProjectList = [
  ...
  },
  {
    ...
    tools: "javascript, react, redux-toolkit",
    whattodo: ["1차 개발 버그 수정", "2차 개발 테스트 진행 및 버그 수정"],
  },
];
